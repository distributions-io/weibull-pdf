...
describe( 'validate', function tests() {
	...
	it( 'should return an error if provided a scale parameter which is not a positive number', function test() {
		var values, err;
	...
	it( 'should return an error if provided a shape parameter which is not a positive number', function test() {
		var values, err;
